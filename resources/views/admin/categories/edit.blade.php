...
<div class="mb-8 flex items-center space-x-4">
    ...
    <h1 class="text-3xl font-serif font-bold text-mocha-text">Edit Category</h1>
</div>
...
<div class="bg-white rounded-2xl border border-gray-100 p-8 max-w-lg shadow-sm">
    <form action="{{ route('admin.categories.update', $category) }}" method="POST">
        ...
        <div class="mb-6">
            ...
            <textarea name="description" id="description" rows="4" class="mt-1 block w-full bg-white border border-gray-200 rounded-xl text-gray-700 focus:ring-mocha-accent focus:border-mocha-accent shadow-sm py-2 px-3">{{ old('description', $category->description) }}</textarea>
